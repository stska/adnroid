...
public class CustomList extends ArrayAdapter {
    ...
    public CustomList(Activity context,Integer imagesArray,String cityArray,String weatherArray,String temperatureArray, String humidityArray,String pressureArray){
        super(context,R.layout.listview_row, Collections.singletonList(cityArray));    //я так и не понял плчему без последнего параметра не работает(((
    ...
    public View getView(int position, View view, ViewGroup parent){
        ...
        imageView.setImageResource(imagesArray);
        cityTextField.setText(cityArray);
        weatherTextField.setText(weatherArray);
        temperatureTextField.setText(temperatureArray);
        humidityTextField.setText(humidityArray);
        pressureTextField.setText(pressureArray);
